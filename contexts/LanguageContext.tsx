...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'modal.seller_inv.redirect_title': 'Redirect to Pipeline?',
  ...
  pt: {
    ...
    'dash.kpi.pipeline': 'Pipeline Ativo',
    ...
    'inv.tab.stock': 'Estoque Físico',
    'inv.tab.catalog': 'Catálogo de Tipologias',
    'inv.physical_stock': 'Estoque Físico',
    ...
    'modal.seller_inv.redirect_title': 'Redirecionar para Pipeline?',
...
export const LanguageProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const formatDate = (date: string | Date, options?: Intl.DateTimeFormatOptions): string => {
    ...
    // Forçamos o uso do locale do sistema
