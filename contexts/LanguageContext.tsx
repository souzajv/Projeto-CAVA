...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'modal.ind_inv.delegated': 'Delegated to Partners',
    'modal.ind_inv.direct_active': 'Direct Active Links',
    ...
    'client.industry_name': 'CAVA Stone Industry',
  ...
  pt: {
    ...
    'modal.ind_inv.delegated': 'Delegado a Parceiros',
    'modal.ind_inv.direct_active': 'Links Diretos Ativos',
    ...
    'client.until': 'até',
    'client.produced_by': 'Produzido por',
    'client.view_catalog': 'Ver Catálogo',
    'client.catalog_title': 'Catálogo Oficial da Coleção',
    'client.industry_name': 'Indústria de Pedras CAVA',
