...
export const ConfirmSaleModal: React.FC<ConfirmSaleModalProps> = ({ offer, stone, onClose, onConfirm }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-[#121212] rounded-sm shadow-2xl w-full max-w-lg overflow-hidden flex flex-col animate-in zoom-in-95 duration-200 border border-[#C5A059]/30 relative"
      ...
      >
        ...
        <div className="p-8 pb-0 flex items-start justify-between">
          <div className="p-3 bg-[#C5A059]/10 rounded-full border border-[#C5A059]/30">
        ...
        <div className="p-8">
          ...
          <p className="text-slate-400 mb-8 font-light text-lg">
            {t('modal.confirm.msg')} <span className="text-white font-serif border-b border-[#C5A059]/50">{offer.clientName}</span>.
          </p>
          ...
          <div className="bg-white/5 border border-white/10 rounded-sm p-6 mb-8 space-y-4 relative overflow-hidden">
            ...
            <div className="flex justify-between items-end relative z-10">
              <span className="text-[10px] font-bold text-[#C5A059] uppercase tracking-widest">{t('modal.confirm.total_rev')}</span>
        ...
        <div className="p-6 bg-white/5 border-t border-white/10 flex gap-4 justify-end">
          ...
          <button 
            onClick={onConfirm}
            className="px-8 py-4 bg-[#C5A059] text-[#121212] text-xs font-bold uppercase tracking-widest hover:bg-[#B08D4C] shadow-[0_0_20px_rgba(197,160,89,0.3)] transition-all flex items-center"
          >
