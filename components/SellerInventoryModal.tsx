  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Redirect Confirmation Modal (Nested) - REFINED IDENTITY */}
        {redirectOffer && (
          <div className="absolute inset-0 z-[60] flex items-center justify-center bg-[#121212]/80 backdrop-blur-md p-4 animate-in fade-in duration-200">
             <div className="bg-white rounded-sm shadow-2xl border border-slate-100 p-8 w-full max-w-md text-center animate-in zoom-in-95 relative overflow-hidden" onClick={e => e.stopPropagation()}>
               {/* Gold Accent Line */}
               <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#C5A059] via-yellow-200 to-[#C5A059]" />
               
               <div className="w-16 h-16 bg-[#C5A059]/10 text-[#C5A059] rounded-full flex items-center justify-center mx-auto mb-6 border border-[#C5A059]/20">
               ...
               <div className="flex gap-4 justify-center">
                  ...
                  <button 
                    ...
                    className="px-8 py-3 bg-[#121212] text-white text-xs font-bold uppercase tracking-widest hover:bg-[#C5A059] shadow-lg transition-all"
                  >
        ...
        {/* OBSIDIAN HEADER (Matching Industry Modal) */}
               ...
               <div className="p-6 space-y-8">
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="p-4 bg-[#121212] text-white text-center shadow-lg">
                           <p className="text-[9px] text-[#C5A059] uppercase font-bold tracking-[0.2em] mb-1">{t('modal.seller_inv.floor_price')}</p>
                           <p className="text-2xl font-serif">{formatCurrency(delegation.agreedMinPrice)}</p>
                      </div>

                      <div className="text-xs text-slate-500 font-light leading-relaxed bg-slate-50 p-4 border border-slate-100 italic">
                         ...
                         {sortedOffers.map(offer => {
                           ...
                           return (
                             <tr key={offer.id} className="hover:bg-slate-50 transition-colors group">
                               ...
                               <td className="px-6 py-4">
                                 <div className="font-bold text-[#121212] group-hover:text-[#C5A059] transition-colors">{offer.clientName}</div>
