...
export const TypologyModal: React.FC<TypologyModalProps> = ({ typology, onClose, onSave }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-[#121212]/90 backdrop-blur-md p-3 sm:p-6 animate-in fade-in duration-300"
      onClick={onClose}
    >
      <div
        className="bg-white rounded-none sm:rounded-sm shadow-2xl w-full max-w-5xl max-h-[95vh] sm:h-[90vh] overflow-hidden flex flex-col border border-white/10"
        onClick={(e) => e.stopPropagation()}
      >

        {/* Header */}
        <div className="sticky top-0 z-10 px-6 sm:px-8 py-5 sm:py-6 border-b border-[#222] flex justify-between items-center bg-[#121212] text-white shrink-0">
          <div>
        ...
        <div className="flex-1 overflow-y-auto bg-[#FAFAFA]">
          <form onSubmit={handleSubmit} className="flex flex-col lg:flex-row h-full">
            ...
            <div className="w-full lg:w-5/12 bg-slate-50 p-6 sm:p-8 border-b lg:border-b-0 lg:border-r border-slate-200 space-y-8 flex flex-col">
            ...
            <div className="flex-1 p-6 sm:p-10 flex flex-col bg-white">
              <div className="space-y-8 flex-1">
                ...
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    className="w-full py-2 bg-white border-b border-slate-200 text-2xl sm:text-3xl font-serif text-[#121212] focus:border-[#121212] outline-none placeholder:text-slate-200"
                ...
                <div className="space-y-3 flex-1 flex flex-col">
                  ...
                  <textarea
                    ...
                    className="w-full p-4 bg-slate-50 border border-slate-200 text-sm leading-relaxed text-slate-700 focus:border-[#121212] outline-none resize-none flex-1 min-h-[160px] sm:min-h-[150px]"
              ...
              {/* Action Buttons */}
              <div className="pt-6 sm:pt-8 border-t border-slate-100 flex flex-col sm:flex-row sm:justify-end gap-3 sm:gap-4">
                <button
                  type="button"
                  onClick={onClose}
                  className="w-full sm:w-auto px-6 py-3 text-xs font-bold uppercase tracking-widest text-slate-500 hover:text-[#121212] transition-colors text-center"
                >
                  {t('common.cancel')}
                </button>
                <button
                  type="submit"
                  className="w-full sm:w-auto px-8 py-3 bg-[#121212] text-white text-xs font-bold uppercase tracking-widest hover:bg-[#C2410C] shadow-lg transition-all flex items-center justify-center"
                >
